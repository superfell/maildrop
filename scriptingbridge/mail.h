...
enum MailHeaderDetail {
	MailHeaderDetailAll = 'hdal' /* All */,
	MailHeaderDetailCustom = 'hdcu' /* Custom */,
	MailHeaderDetailDefault = 'hdde' /* Default */,
	MailHeaderDetailNoHeaders = 'hdnn' /* No headers */
};
typedef enum MailHeaderDetail MailHeaderDetail;

enum MailLdapScope {
	MailLdapScopeBase = 'lsba' /* LDAP scope of 'Base' */,
	MailLdapScopeOneLevel = 'lsol' /* LDAP scope of 'One Level' */,
	MailLdapScopeSubtree = 'lsst' /* LDAP scope of 'Subtree' */
};
typedef enum MailLdapScope MailLdapScope;
...
enum MailViewerColumns {
	...
	MailViewerColumnsBuddyAvailabilityColumn = 'ecba' /* Column indicating whether the sender of a message is online or not */,
...
enum MailMessageCachingPolicy {
	...
	MailMessageCachingPolicyDoNotKeepCopiesOfAnyMessages = 'x9no' /* Do not keep copies of any messages */,
	MailMessageCachingPolicyOnlyMessagesIHaveRead = 'x9wr' /* Only messages I have read */
};
...
enum MailRuleType {
	...
	MailRuleTypeSenderIsInMyAddressBook = 'tsii' /* Sender is in my address book */,
	...
	MailRuleTypeSenderIsNotInMyAddressBook = 'tsin' /* Sender is not in my address book */,
...
@interface MailLdapServer : SBObject
...
@property MailLdapScope scope;  // Scope setting for the LDAP server
...
@property MailHeaderDetail headerDetail;  // The level of detail shown for headers on incoming messages
